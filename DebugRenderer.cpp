...
void DebugRenderer::InitRenderer(ID3D11Device *pDevice, UINT bufferSize)
{
	...
	m_pEffect = ContentManager::GetInstance()->Load<ID3DX11Effect>(L"Effects/DebugRenderer.fx");
...
void DebugRenderer::DrawGrid(const SceneContext& sceneContext)
{
	...
	{
		Logger::GetInstance()->LogInfo(L"DebugRenderer::Draw() > Increasing Vertexbuffer Size!");
